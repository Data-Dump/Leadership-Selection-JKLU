...
-- Initial Seed Data (Admin Accounts, Rubric, Selection Cycle)
-- ============================================================

-- 1. Evaluators (Committee Admin Accounts)
INSERT INTO evaluators ("id", "name", "email", "role", "active", "passwordHash", "createdAt")
VALUES
  ('eval-admin-anushka', 'Anushka Pathak', 'anushka.pathak@jklu.edu.in', 'Admin', true, 'demo:admin123', 1725114000000),
  ('eval-admin-rattan', 'Rattan Gangadhar', 'rattan.gangadhar@jklu.edu.in', 'Admin', true, 'demo:admin123', 1725114000000),
  ('eval-admin-richa', 'Richa Sharma', 'richasharma@jklu.edu.in', 'Admin', true, 'demo:admin123', 1725114000000),
  ('eval-admin-vaibhav', 'Vaibhav Topiwala', 'vaibhav.topiwala@jklu.edu.in', 'Admin', true, 'demo:admin123', 1725114000000),
  ('eval-admin-panel', 'Panel Access', 'panel.access@kaushal.sbs', 'Admin', true, 'demo:admin123', 1725114000000)
